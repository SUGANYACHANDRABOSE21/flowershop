            ...
            <nav className='mt-5'>
                <div className='md:flex justify-between w-5/6 md:max-w-7xl mx-auto'>
                    <div className='flex justify-between'>
                        <div>
                            <span className='text-pink-500 font-bold text-4xl'>Flower</span>
                            <span className='text-sky-500 font-thin text-3xl'>Shop</span>
                        </div>
                    ...
                    <div className={`flex md:block justify-end ${open ? "block" : "hidden"}`}>
                        <ul className='md:flex md:space-x-8 space-y-8 md:space-y-0'>
                            <li className='menu'>
                                <a className='font-body' href='#'>Flower</a>
                            </li>
                            <li className='menu border-b-4'>
                                <a className='font-body' href='#'>Gifts</a>
                            </li>
                            <li className='menu'>
