...
<footer class="bg-pink-300 dark:bg-sky-500 w-full py-8">
    <div class="max-w-screen-xl px-4 mx-auto">
        <ul class="flex flex-wrap justify-between max-w-screen-md mx-auto text-lg font-light">
            ...
            <li class="my-2">
                <a class="text-black-900 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">
                    our products
                </a>
            </li>
            <li class="my-2">
